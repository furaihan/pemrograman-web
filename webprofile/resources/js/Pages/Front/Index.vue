...
import WatermelonJSON from '/public/img/wlb.json';
import SwitchJSON from '/public/img/switch.json';
    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <LottieAnimation :animation-data="SwitchJSON" :auto-play="true" :loop="true" :speed="1" ref="anim"
                    class="mr-3 h-16 w-auto" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Nintendo</span>
            </a>
    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <div class="flex flex-col justify-center pt-6 lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <h4 class="font-body text-lg font-semibold uppercase text-grey-20">
                            Connect with me
                        </h4>
                    ...
                    <div class="flex items-center justify-center mt-3 sm:justify-start sm:pt-0">
                        <a href="https://github.com/furaihan">
                            <font-awesome-icon :icon="['fab', 'github']" />
                        </a>
                        <a href="https://www.instagram.com/zhafar.af" class="pl-4">
                        ...
                        <a href="https://www.youtube.com/channel/UCCg6AXtkexjtDo-7EHCTqcA" class="pl-4">
            ...
            <div class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
                <div v-for="item in skill" :key="item.id">
                    ...
                    <div class="mt-2 bg-lila w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div class="bg-blue-600 h-2.5 rounded-full" style="width: {{item.content}}%"></div>
                    </div>
                </div>
            </div>
        </div>
